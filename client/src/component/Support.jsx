...
export default function Support() {
    ...
    function onclickTalent (){
        ...
        setTimeout(() => {
                btnAnim.current.textContent = "The talent";
        }, 200);
    ...
    function onclickClient(){
        ...
        secondSpan.current.style.opacity ="0";
         setTimeout(() => {
                btnAnim.current.textContent = "The clients";
        }, 200);
         allTitreSouligne.forEach(element => {
    ...
    <div style={{fontFamily:"Libre Baskerville"}} className='supp456:h-[1500px] w-screen h-[1200px] bg-blanc flex flex-col items-center justify-around '>
        <div className='h-[160px] flex flex-col items-center justify-around  '>
            ...
            <div  className='w-[270px] supp550:w-[350px] flex items-center justify-between h-[50px] relative py-[28px] px-[30px]  border-[3px] border-bleuGris rounded-[50px]  '>
                ...
                <BtnSpanSupport reference={firstSpan} click={onclickTalent} text={"The talent"} ></BtnSpanSupport>
                <BtnSpanSupport reference={secondSpan} click={onclickClient} text={"The clients"} ></BtnSpanSupport>
            </div>
        </div>
        <DesignTechnoManagement refUne={divDesigneBrand} refDeux={titreSouligneUn} refTrois={titreSouligneCacheUn} textUn={"Design"} textDeux="Brand"  ></DesignTechnoManagement>         
        <DesignTechnoManagement refUne={divTechnologieEntreprise} refDeux={titreSouligneDeux} refTrois={titreSouligneCacheDeux} textUn={"Technologie"} textDeux="Entreprises" ></DesignTechnoManagement>
        <DesignTechnoManagement refUne={divManagamentStartup} refDeux={titreSouligneTrois} refTrois={titreSouligneCacheTrois} textUn={"Management"} textDeux="Startup|Tech"  ></DesignTechnoManagement>
        <div className='relative'>
            <div ref={affichageInformation}  style={{boxShadow:"rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px"}} className='supp456:w-[350px] supp456:left-[-350%] supp550:w-[400px] supp550:top-[-400%] supp550:left-[-400%] w-[300px] top-[-500%] left-[-300%] absolute bg-white p-6 text-center text-xl text-grisTexte leading-[34px] rounded-[10px] transform rotate-[-3deg] opacity-0 transition-all duration-300 ease-in-out '>
                say hey, we'll awlays be honnest about what we focus on, and what we dont.
            </div>
