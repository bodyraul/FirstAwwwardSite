...
export default function Work() {
  ...
  return (
    <div className="supp480:h-[1450px] supp768:h-[1700px] supp1024:h-[1650px] supp1600:h-[1700px] h-[1400px] w-screen bg-orangeMarron flex items-center justify-center transform translate-x-[-5px]">
